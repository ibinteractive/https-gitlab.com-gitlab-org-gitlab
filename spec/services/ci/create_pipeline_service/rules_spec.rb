      ...
      context 'variables:' do
        ...
        context 'when no match' do
          ...
          it 'does not affect vars' do
            ...
            expect(variables['VAR6']).to be_nil
            expect(variables['VAR7']).to eq('workflow var 7')
          end
        end
        ...
        context 'when matching to the second rule' do
          ...
          it 'overrides VAR2 and VAR7 by job, then adds VAR3 by job and VAR6 by workflow' do
            variables = job.scoped_variables_hash
            ...
            expect(variables['VAR4']).to eq('workflow var 4')
            expect(variables['VAR5']).to eq('job var 5')
            expect(variables['VAR6']).to eq('new workflow var 6')
